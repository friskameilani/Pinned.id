                ...
                <div class="col-md-6">
                    ...
                    <form method="POST" action="{{ url('admineditcatalog') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="dropdown">
                                <button class="btn dropdown-toggle text-right border border-dark" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width: 492px; background-color: white;">
                                </button>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 492px;">
